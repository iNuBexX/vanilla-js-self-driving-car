class Car {
    constructor(x, y, width, height, controlType, maxSpeed=3,timeToLive=300,rayCount=8, raySpread=Math.PI, rayLength=150, networkArchitecture) {
        this.x = x;
        this.y = y;
        ...
        if(this.controlType!="AI"){
            ...
            this.brain = new NeuralNetwork(networkArchitecture);
        }
